...
set_false_path -from [get_cells -hier -filter {name =~ *reg_autocorrConfig*  && IS_SEQUENTIAL}]
#-to [all_registers]
set_false_path -from [get_cells -hier -filter {name =~ *reg_peakDetectConfig*  && IS_SEQUENTIAL}]
#-to [all_registers]
set_false_path -from [get_cells -hier -filter {name =~ *reg_autocorrFF*  && IS_SEQUENTIAL}]
#-to [all_registers]
set_false_path -from [get_cells -hier -filter {name =~ *reg_freqScaleFactor*  && IS_SEQUENTIAL}]
#-to [all_registers]
