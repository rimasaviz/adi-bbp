...
adi_ip_create axi_ofdmbbp_rx
adi_ip_files axi_ofdmbbp_rx [list \
...
adi_ip_properties axi_ofdmbbp_rx
adi_ip_constraints axi_ofdmbbp_rx [list \
  "axi_ofdmbbp_rx_constr.xdc" ]
