...
set axi_ofdmbbp_rx [create_bd_cell -type ip -vlnv analog.com:user:axi_ofdmbbp_rx:1.0 axi_ofdmbbp_rx]
set_property -dict [list CONFIG.XCOMM2IP_1T1R_OR_2T2R_N {1}] $axi_ofdmbbp_rx

# FIXME: should use a different address for tx/rx
ad_cpu_interconnect 0x79040000 axi_ofdmbbp_rx

ad_connect  axi_ad9361/clk axi_ofdmbbp_rx/clk
ad_connect  axi_ad9361/rst axi_ofdmbbp_rx/rst
ad_connect  axi_ad9361/adc_valid_i0 axi_ofdmbbp_rx/adc_valid_i0
ad_connect  axi_ad9361/adc_data_i0 axi_ofdmbbp_rx/adc_data_i0
ad_connect  axi_ad9361/adc_valid_q0 axi_ofdmbbp_rx/adc_valid_q0
ad_connect  axi_ad9361/adc_data_q0 axi_ofdmbbp_rx/adc_data_q0
ad_connect  axi_ad9361/adc_valid_i1 axi_ofdmbbp_rx/adc_valid_i1
ad_connect  axi_ad9361/adc_data_i1 axi_ofdmbbp_rx/adc_data_i1
ad_connect  axi_ad9361/adc_valid_q1 axi_ofdmbbp_rx/adc_valid_q1
#ad_connect  axi_ad9361/adc_data_q1 axi_ofdmbbp_rx/adc_data_q1
#ad_connect  axi_ofdmbbp_rx/dac_valid_i0 axi_ad9361/dac_valid_i0
#ad_connect  axi_ofdmbbp_rx/dac_data_i0 axi_ad9361/dac_data_i0
#ad_connect  axi_ofdmbbp_rx/dac_valid_q0 axi_ad9361/dac_valid_q0
#ad_connect  axi_ofdmbbp_rx/dac_data_q0 axi_ad9361/dac_data_q0
#ad_connect  axi_ofdmbbp_rx/dac_valid_i1 axi_ad9361/dac_valid_i1
#ad_connect  axi_ofdmbbp_rx/dac_data_i1 axi_ad9361/dac_data_i1
#ad_connect  axi_ofdmbbp_rx/dac_valid_q1 axi_ad9361/dac_valid_q1
#ad_connect  axi_ofdmbbp_rx/dac_data_q1 axi_ad9361/dac_data_q1
#ad_connect  axi_ofdmbbp_rx/dac_dovf axi_ad9361/dac_dovf
#ad_connect  axi_ofdmbbp_rx/dac_dunf axi_ad9361/dac_dunf
