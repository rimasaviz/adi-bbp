...
create_project zc706.txrx . -part xc7z045ffg900-2 -force
...
set_property -dict [list CONFIG.XCOMM2IP_1T1R_OR_2T2R_N {0}] $axi_ofdmbbp_rx
ad_cpu_interconnect 0x79080000 axi_ofdmbbp_rx
...
generate_target {synthesis implementation} [get_files zc706.txrx.srcs/sources_1/bd/system/system.bd]
make_wrapper -files [get_files zc706.txrx.srcs/sources_1/bd/system/system.bd] -top
import_files -force -norecurse -fileset sources_1 zc706.txrx.srcs/sources_1/bd/system/hdl/system_wrapper.v

adi_project_files zc706.txrx [list \
